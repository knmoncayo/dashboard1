// Configuration with AWSs-east-1:f79208a2-a26f-us-east-1:f79208a2-a26f-4c2b-be6d-ec367432ddeds-east-1:f79208a2-a26f-4c2b-be6d-ec367432dded Cognito Identity Credentials.
AWS.config.region = "us-east-1";
AWS.config.credentials = new AWS.CognitoIdentityCredentials({
    IdentityPoolId: "us-east-1:3284c512-e65c-4edd-af0a-d3af08935b00"
});
            ...
            stations.forEach(function (id) {
                ...
                docClient.query(params, function (err, data) {
                    if (err) {
                        ...
                        document.getElementById('latest-value3').innerHTML = latest.windDirection + '°C';
                        document.getElementById('latest-value4').innerHTML = latest.windIntensity ;
                        document.getElementById('latest-value5').innerHTML = latest.rainHeight ;
