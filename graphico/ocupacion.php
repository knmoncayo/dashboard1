...
require_once('dbconnect.php');
	...
	$sql="SELECT COUNT(ocupaciont) FROM tecnicos_ocupaciones WHERE ocupaciont = 'Extractor';";
	$conn->sqlQuery($sql);
	$filas1 = $conn->rows[0];
	
	$sql1="SELECT COUNT(ocupaciont) FROM tecnicos_ocupaciones WHERE ocupaciont = 'Colmena';";
	$conn->sqlQuery($sql1);
	$filas2 = $conn->rows[0];
	
	$sql2="SELECT COUNT(ocupaciont) FROM tecnicos_ocupaciones WHERE ocupaciont = 'Cuidador';";
	$conn->sqlQuery($sql2);
	$filas3 = $conn->rows[0];
...
$strXML = "<chart caption = 'GRAFICOS ESTADISTICOS DE FUNCION DE LOS TECNICOS' bgColor='#FFFFFF' baseFontSize='12' showValues='1' xAxisName='FUNCION' >";
...
$strXML .= "<set label = 'Extractores' value ='".$intTotalAnio1."' color = 'FF66FF' />";
$strXML .= "<set label = 'Colmena' value ='".$intTotalAnio2."' color = '0000FF' />";
$strXML .= "<set label = 'Cuidador' value ='".$intTotalAnio3."' color = 'FDF207' />";
...
?></td>
  ...
  <tr>
    <td height="52" colspan="2"><div align="center"><span class="Estilo7">Copy</span>
      <table width="138" height="32" border="1" align="center" bordercolor="#990033" bgcolor="#FFFFFF">
        <tr>
          <td width="179"><div align="center"><em><strong><a href="http://localhost/biblioteca/estadistica.php">Volver</a></strong></em></div></td>
        </tr>
      </table>
      <p></p>
      <span class="Estilo7"><img src="../assets/img/EmpresaEpicola/teccnii.PNG" alt="hhh" width="1115" height="552" />right 2015 LivitaSport</span></div></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
